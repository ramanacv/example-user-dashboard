...
<Flex>
    <Container w={[1280]} >
      ...
      pos='relative'
      >
        <Flex align="center" justify="left" w={[1, 1, 0.3]} pl={[15]} py={[7]} direction={['row']} >
          <Link to="/">
            <Heading level={4} color='white' mb={0} fontSize={[3,4]} fontWeight={'100'}>
              <strong>Demo</strong> User Dashboard
            </Heading>
          </Link>
        </Flex>
        
        <Flex align="center" w={[1, 1, 0.4]} justify="center" display={['none', 'none', 'Flex']} py={[15]} >

        </Flex>
  
        <Flex align="center" justify='flex-end' py={[10]} color='white' w={[1, 1, 0.3]} textAlign="center">
          <DrawerOpen>
