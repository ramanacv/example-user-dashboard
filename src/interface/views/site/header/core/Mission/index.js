    ...
    <Flex direction={['column', 'row']}  mh={['80vh']} align='center' justify={['center']} >
      <Box w={[1,1,0, 0.5]} color='white' px={[20,40]}  >
        ...
        <Heading level={[3]} f={[2,3]}mb={25}  >
          A Launchpad for Frontend Blockchain Developers
        </Heading>
        <Paragraph f={[2]}>
          Easily launched distributed applications with decentralized identity at the core. Stop worrying about databases, new regulations and securing backend systems.
        </Paragraph>
        <Paragraph f={[1]}>
