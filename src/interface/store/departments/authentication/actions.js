...
/*--- Identity Login ---*/
export const AUTH_LOGIN_WITH_IDENTITY_REQUEST = 'AUTH_LOGIN_WITH_IDENTITY_REQUEST'
export const AUTH_LOGIN_WITH_IDENTITY_SUCCESS = 'AUTH_LOGIN_WITH_IDENTITY_SUCCESS'
export const AUTH_LOGIN_WITH_IDENTITY_FAILURE = 'AUTH_LOGIN_WITH_IDENTITY_FAILURE'
...
export const authLoginWithIdentity = ({payload = {}, metadata = {}}) => ({
  type: AUTH_LOGIN_WITH_IDENTITY_REQUEST,
  payload,
  metadata
})
